...
import { AllUsersResponse, DeleteUsersRequest, MessageResponse, UserResponse } from "../../types/api-types";
...
export const userAPI = createApi({
    ...
    endpoints: (builder) => ({
        ...
        deleteUser: builder.mutation<MessageResponse, DeleteUsersRequest>({
